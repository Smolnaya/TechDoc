...
Заголовок 3 уровня
    ...
    - отступ абзацный
 */
public class ThirdLevelHeader {
    private String level = "heading 3"; //XWPFDocument.getStyles().getStyle(xwpfParagraph.getStyleID()).getName())
    private String fontStyleName = "Times New Roman";
    private int fontSize = 14;
    private Boolean fontBold = false;
    private Boolean fontItalic = true;
